    ...
    <main className={`guide ${theme.darkmode ? "dark" : "light"}`}>
      ...
      <section className="add-folder-guide">
        ...
        <div className="section-content-guide">
          <p>
            Para agregar un nuevo folder, dirigete a la sección Inventario y haz
            click en el botón <i>agregar folder</i>.
          </p>
      ...
      <section className="add-category-guide">
        ...
        <div className="section-content-guide">
          <p>
            ...
            <i>Agregar Categoría</i> y elige el nombre que quieres para la nueva
            categoría
          </p>
          <p>
      ...
      <section className="add-edit-category-guide">
        ...
        <div className="section-content-guide">
          <p>
            Para editar una categoria debes oprimir el boton: que esta a un lado
            del nombre
          </p>
          <p>
